...
task :assets do
  ...
  sh "$HOME/go/bin/go-bindata -o blobs/assets.go -pkg blobs assets/*.yaml assets/*.zip assets/man/* docs/changelog.md docs/features.md docs/usecases.md docs/recipes.md"
end
